...
#define ENABLE_RGB_MATRIX_SOLID_MiLTISPLASH
...
#define MANUFACTURER    777
#define PRODUCT         777
#define DESCRIPTION     777
...
#define MATRIX_COL_PINS { B10, A0, A1, A2, A3, A4, A5, A7, B0, B1, C15, A8, B15, A10 }
#define UNUSED_PINS
